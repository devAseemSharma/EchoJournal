package com.androidace.echojournal.audio.waveform
...
import androidx.compose.ui.unit.dp
import com.androidace.echojournal.util.chunkToSize
import com.androidace.echojournal.util.fillToSize
import com.androidace.echojournal.util.normalize
...
private const val MinSpikeHeight: Float = 0.5F
...
private fun List<Int>.toDrawableAmplitudes(
    ...
    }.normalize(minHeight, maxHeight).map { if (it.isNaN()) 0f else it }
}
